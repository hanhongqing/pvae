...
source ../config.txt
export CUDA_VISIBLE_DEVICES=0 && python ../../unsup_seg_vae/main_BetaSeg.py\
 --path_train $PATH_INPUT_BETASEG_HIGH_C1\
 --path_train $PATH_INPUT_BETASEG_HIGH_C2\
 --path_train $PATH_INPUT_BETASEG_HIGH_C3\
 --path_test $PATH_INPUT_BETASEG_HIGH_C4\
